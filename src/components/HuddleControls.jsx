...
import { toggleHuddle, toggleScreenShare, toggleDrawing } from '../store/slices/chatSlice';
    ...
    <div className="flex gap-4">
      ...
      {huddleState.isActive && (
        <>
          ...
          >
            {huddleState.isScreenSharing ? 'Stop Sharing' : 'Share Screen'}
          </button>
          ...
          >
            {huddleState.isDrawing ? 'Stop Drawing' : 'Start Drawing'}
          </button>
        </>
      )}
    </div>
